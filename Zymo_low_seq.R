# R script to generate the stacked barcharts for the Zymo dataset in the paper: "Accurate alignment-based classification of metagenomic sequences with NABAS+"
# Author: Erda Qorri
# Date: 06-12-2022
...
# Import dataset
abundances_small <- read.csv("path_to_file.csv", sep = "\t", header = FALSE)

# Generate plot for deeply sequenced samples
abundances_small_plot <- abundances_small %>%
