...
public class CoverageIndex {
    ...
    public HashMap<String, Integer> chrIndex;
    public HashMap<String, HashMap<Integer, Integer>> millionStep;
    public HashMap<String, HashMap<Integer, Integer>> fiftythousandStep;
